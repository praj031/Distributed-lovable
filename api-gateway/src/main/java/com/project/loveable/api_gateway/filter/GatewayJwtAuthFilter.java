package com.project.loveable.api_gateway.filter;


import com.project.loveable.api_gateway.config.SecurityProperties;
import com.project.loveable.api_gateway.error.ApiError;
import com.project.loveable.api_gateway.service.JwtGatewayService;
...
public class GatewayJwtAuthFilter implements GlobalFilter, Ordered {
    ...
    //Intercept all the methods and verify and goes to the next filters
    @Override
    ...
    //Here we can define the order of the filter, like where filter should be appended
    @Override
    public int getOrder() {
        return -1;
    }
