package com.project.loveable.workspace_service.consumer;

import com.project.loveable.common_lib.event.FileStoreRequestEvent;
import com.project.loveable.common_lib.event.FileStoreResponseEvent;
import com.project.loveable.workspace_service.entity.ProcessedEvent;
import com.project.loveable.workspace_service.repository.ProcessedEventRepository;
...
public class FileStorageConsumer {
    ...
    public void consumeFileEvent(FileStoreRequestEvent requestEvent) {
        ...
        // Idempotency check : That the event is not repeated only once happening.
