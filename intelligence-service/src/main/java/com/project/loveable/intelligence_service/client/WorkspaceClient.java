package com.project.loveable.intelligence_service.client;
...
//Here we are describing the URL or the end-point to be fixed, either it goes via URL or normal locally via end-point.
